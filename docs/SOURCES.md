...
Inline numbers match the 2026-09-17 research pass; 10–14 are the 2026-09-20 still-factory pass; 15–16 are the 2026-09-21 production-flow pass.
...
15. [MCPlato: AI short drama tools 2026](https://mcplato.com/en/blog/ai-short-drama-generation-tools-2026-production-workflow) — the bottleneck is script/storyboard/character plus a production-workflow layer, not a single video model. Extract the layering; do not take the tool ranking as SMF pins.
16. [Forget-C/Jellyfish](https://github.com/Forget-C/Jellyfish) — Apache-2.0 short-drama studio: script → storyboard → consistency assets → async generate. Idea only. SMF does not wholesale-adopt the codebase.
